...
Execute all of the following detection methods in parallel using the available web page retrieval tool and the available web search tool. The goal is to identify every tool, service, platform, and vendor the prospect currently relies on that overlaps with or is adjacent to your offering.
...
Search for the prospect's open job postings using the available web search tool with queries like:
...
- the available web search tool: "[Company Name] case study [Competitor Name]"
- the available web search tool: "[Company Name] customer story"
- the available web search tool: "[Company Name] testimonial"
...
- the available web search tool: "site:g2.com [Company Name]"
- the available web search tool: "site:capterra.com [Company Name]"
- the available web search tool: "[Company Name] review [tool category]"
...
- the available web search tool: "site:builtwith.com [Company Domain]"
- the available web search tool: "site:stackshare.io [Company Name]"
- the available web search tool: "[Company Domain] technology stack"
...
- the available web search tool: "[Company Name] [tool category] site:linkedin.com"
- the available web search tool: "[Company Name] 'we use' OR 'switched to' OR 'implemented' [tool category]"
