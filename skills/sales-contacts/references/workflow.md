...
Use `the available web page retrieval tool` to fetch these pages (skip any already provided in the discovery briefing):
...
Use `the available web search tool` to find key stakeholders on LinkedIn. Execute these searches:
