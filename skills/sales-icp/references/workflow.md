...
Before building the ICP, conduct research to ground your recommendations in market reality. Use the available web search tool to validate your assumptions:
...
6. Write the file to disk using the available file-writing tool. Confirm to the user what was written and where.
