...
If the user provides a URL instead of a topic, fetch the website using the available web page retrieval tool and determine the industry, company size, and likely objections based on the research.
...
If the user provides a URL, use the available web page retrieval tool to research the specific company and generate objections tailored to that company's situation, not just the industry.
