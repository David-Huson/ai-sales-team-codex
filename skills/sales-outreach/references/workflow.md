...
Use `the available web search tool` to find recent company triggers. These create natural, timely reasons to reach out.
...
Research the specific person you are targeting. Use `the available web search tool` for each priority contact:
