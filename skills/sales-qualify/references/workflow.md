...
Gather qualification signals from these sources. Use `the available web page retrieval tool` for website pages and `the available web search tool` for external data.
...
1. **Fetch the source** using the available web page retrieval tool or the available web search tool
