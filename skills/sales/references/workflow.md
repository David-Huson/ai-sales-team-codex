...
This command performs five analyses. Use parallel workers when supported and permitted, otherwise run them sequentially:
...
1. Fetch the homepage using the available web page retrieval tool
